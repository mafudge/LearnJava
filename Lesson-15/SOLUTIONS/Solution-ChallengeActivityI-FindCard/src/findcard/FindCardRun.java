/*
 * Challenge Activity I - Find the Card
 * 
 * In this activity, we will write code to deal out 7 cards each to 4 players 
 * from a shuffled deck. 
 * 
 * Next the program should display where the A♠ is located - with one of the hands
 * or still found in the remaining deck.
 * 
 * => You will need to implement the indexOf() methods in Deck.java and Hand.java 
 *    before attempting to implement main() java.
 * 
 * 
 * 
...
public class FindCardRun {
    ...
    public static void main(String[] args) {
        ...
        //      to count to 4 where you deal a card to the hand.
        for(int i=0;i<7;i++) {
        ...
        //TODO: Loop over all 4 hands printing the cards in the hand, and whether you found the card
        //      and one last print for the remaining deck
        for(int j=0;j<hands.length;j++) {
