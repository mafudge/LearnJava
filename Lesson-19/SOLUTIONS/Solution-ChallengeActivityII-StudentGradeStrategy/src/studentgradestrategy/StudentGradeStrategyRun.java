/*
 * Challenge Activity II - The "Strategy pattern" and Grade distributions.
 * 
 * Some students take a class for a grade, others take the classs pass/fail
 * how do we accomodate this scenairo yet still keep some flexibility for
